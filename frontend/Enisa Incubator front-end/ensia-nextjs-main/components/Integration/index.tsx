      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Connected Tools That Power Your Incubation Experience`,
              description: `The platform integrates with key services like email, cloud storage, notifications, and document sharing — making communication and file access easier for all roles involved.`,
            }}
          />
