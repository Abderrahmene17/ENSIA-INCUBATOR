          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Ready to Launch Your Startup with ENSIA?
              </h2>
              <p>
                Apply to the incubator, connect with mentors, attend workshops, and track your progress — all from one place built for ENSIA students.
              </p>
            </motion.div>
            <motion.div
              variants={{
            ...
            >
              <div className="flex items-center justify-end xl:justify-between">
                ...
                />
                <a
                    href={typeof window !== "undefined" && localStorage.getItem("access_token") ? "/incubation-form" : "/auth/signin"}
